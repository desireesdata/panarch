...
Blabla why haskell is a good langague for THIS case (Schematron is an orthogonal validator : good its adds a layer of complexity to the data pipeline). "Parse don't validate", arise errors properly (XSLT is bad for this i think !) etc, etc.
